...
export const features = [
  ...
  },
  {
    ...
    description: "Upload your resume to get clear feedback on structure, skills, tone and style and areas that need improvement.",
    bg: "bg-pink-100",
  },
  {
    icon: <FileText className="w-10 h-10 mb-4 text-indigo-500" />,
