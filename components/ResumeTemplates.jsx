...
const ResumeTemplate = ({ data, user, activeStyle }) => {
    ...
    const renderAcademic = () => {
        ...
        return (
            <div id="resume-academic" className="bg-white p-[35px_45px] max-w-[210mm] mx-auto min-h-[297mm] text-[#334155] leading-[1.5] font-sans text-[10.5pt]">
                ...
                <section className="mb-3">
                    ...
                    <div className="flex flex-wrap gap-1.5">
                        {userSkills.map((skill, i) => (
                            <span key={i} className="px-2.5 py-1 rounded-[4px] text-[10px] border border-[#e2e8f0] font-semibold text-[#334155] uppercase">{skill.trim()}</span>
                        ))}
                    </div>
                </section>
            </div>
    ...
    const renderCorporate = () => {
        ...
        return (
            <div id="resume-corporate" className="bg-white p-[35px_45px] max-w-[210mm] mx-auto min-h-[297mm] text-[#334155] leading-[1.5] font-sans text-[10.5pt]">
