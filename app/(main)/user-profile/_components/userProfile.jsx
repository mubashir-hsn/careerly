...
export default function UserProfilePage({ user }) {
  ...
  const industryName =
    industries.find((ind) => ind.id.toLowerCase() === industry.toLowerCase())
      ?.name || "Professional";
      ...
      <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="md:col-span-2 space-y-8">
          <section className="space-y-6">
            ...
            <Card className="border-none shadow-xl rounded-4xl bg-white p-2">
              <CardContent className="p-6 grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="flex items-center gap-4 p-4 rounded-2xl bg-slate-50 border border-slate-100 transition-all hover:shadow-md">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="font-bold text-slate-800 ">{industryName}</p>
                  </div>
                </div>
        ...
        <div className="space-y-8">
          <section className="space-y-6">
            ...
            <Card className="border-none shadow-xl rounded-4xl bg-white h-full">
